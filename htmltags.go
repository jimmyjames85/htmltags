...
func (d *Document) A(attr ...string)                   { fmt.Fprintf(d, "%s", A(attr...)) }
func (d *Document) AClose(attr ...string)              { fmt.Fprintf(d, "%s", AClose()) }
func (d *Document) AHref(href, text string)            { fmt.Fprintf(d, "%s", AHref(href, text)) }
...
func (d *Document) IMG(attr ...string)                 { fmt.Fprintf(d, "%s", IMG(attr...)) }
func (d *Document) Image(src, width, height string)    { fmt.Fprintf(d, "%s", Image(src, width, height)) }
...
func A(attr ...string) string       { return tagWithAttr("a", attr...) }
func AClose() string                { return closeTag("a") }
...
func HTMLClose() string             { return closeTag("html") }
...
func IMG(attr ...string) string     { return tagWithAttr("img", attr...) }
...
func AHref(href, text string) string {
	return fmt.Sprintf("%s%s%s", A(fmt.Sprintf("href=%q", href)), text, AClose())
}

func Image(src, width, height string) string {
	return IMG(fmt.Sprintf("src=%q", src), fmt.Sprintf("width=%q", width), fmt.Sprintf("height=%q", height))
}
